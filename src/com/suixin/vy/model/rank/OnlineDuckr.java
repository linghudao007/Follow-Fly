...
public class OnlineDuckr implements Serializable{	private static final long serialVersionUID = 2094789269L;	private String descInfo;	private String coverUrl;	private String content;	private long weight;	private String coverThumbUrl;	private long categoryId;	private String websiteCoverThumbUrl;	private String websiteCoverUrl;	private String title;	private long type;
...
	public OnlineDuckr(String descInfo, String coverUrl, String content, long weight, String coverThumbUrl, long categoryId, String websiteCoverThumbUrl, String websiteCoverUrl, String title, long type){
		super();		this.descInfo = descInfo;		this.coverUrl = coverUrl;		this.content = content;		this.weight = weight;		this.coverThumbUrl = coverThumbUrl;		this.categoryId = categoryId;		this.websiteCoverThumbUrl = websiteCoverThumbUrl;		this.websiteCoverUrl = websiteCoverUrl;		this.title = title;		this.type = type;
	}
	public String toString() {
		return "OnlineDuckr [descInfo = " + descInfo + ", coverUrl = " + coverUrl + ", content = " + content + ", weight = " + weight + ", coverThumbUrl = " + coverThumbUrl + ", categoryId = " + categoryId + ", websiteCoverThumbUrl = " + websiteCoverThumbUrl + ", websiteCoverUrl = " + websiteCoverUrl + ", title = " + title + ", type = " + type + "]";	}
}