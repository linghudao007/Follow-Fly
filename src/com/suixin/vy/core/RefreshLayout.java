...
public class RefreshLayout extends LinearLayout implements OnTouchListener {
	...
	public RefreshLayout(Context context, AttributeSet attrs) {
		...
		header = LayoutInflater.from(context).inflate(R.layout.view_fullrefresh,
				null, true);
		progressBar = (CirclePro) header.findViewById(R.id.progress_bar);
