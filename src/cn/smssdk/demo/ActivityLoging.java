...
public class ActivityLoging extends Activity implements OnClickListener, Callback {
	// 填写从短信SDK应用后台注册得到的APPKEY
    private static String APPKEY = "13e597de37b90";

	// 填写从短信SDK应用后台注册得到的APPSECRET
	private static String APPSECRET = "a833a5f03a85662007b5b469223ec6f6";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (Build.VERSION.SDK_INT >= 23) {
			int readPhone = checkCallingOrSelfPermission(Manifest.permission.READ_PHONE_STATE);
			int readSms = checkCallingOrSelfPermission(Manifest.permission.READ_SMS);
			int readContacts = checkCallingOrSelfPermission(Manifest.permission.READ_CONTACTS);
			int readSdcard = checkCallingOrSelfPermission(Manifest.permission.READ_EXTERNAL_STORAGE);
	...
	private void requestPermissions(String[] array, int requestCode) {
